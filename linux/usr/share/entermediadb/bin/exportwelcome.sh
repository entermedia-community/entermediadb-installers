...
CLIENT_ID=$2
CLIENT_NAME=$3
sed "s:%client_name%:$CLIENT_NAME:g;s:%client_id%:$CLIENT_ID:g;s:%client_domain:$CLIENT_DOMAIN:g" </opt/entermediadb/common/client_template/index.html.client >/opt/entermediadb/webapp/$CLIENT_ID/index.html
